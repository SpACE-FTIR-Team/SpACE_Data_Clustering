...
class SpaceApp(tk.Frame):
	...
	def _create_widgets(self):
		...
		self._Entry_k = tk.Entry(self._LabelFrame_kmeans, width = 5, justify = "center", textvariable = self._Var_kmeans_clusters)
		...
		self._Entry_minpts = tk.Entry(self._Frame_dbscan_parameters, width = 5, justify = "center", textvariable = self._Var_minpts)
